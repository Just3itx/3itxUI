...
-- GC Library
declare function getgc(include_tables: boolean?): { any }
...
export type ExecutorSignal<T... = ...any> = {
	Connect: (self: ExecutorSignal<T...>, callback: (T...) -> ()) -> SignalConnection,
	Once: (self: ExecutorSignal<T...>, callback: (T...) -> ()) -> SignalConnection,
	Wait: (self: ExecutorSignal<T...>) -> T...,
	Fire: (self: ExecutorSignal<T...>, T...) -> ()
}

declare ExecutorSignal: {
	new: (<T...>() -> ExecutorSignal<T...>),
}
...
declare on_actor_state_created: ExecutorSignal<Actor>
...
declare function request(request_options: RequestOptions): RequestResponse
...
declare getcallbackmember: (
	...
	((instance: Instance, property_name: string, return_raw: boolean?) -> ((...any) -> ...any)?) )
...
declare function saveinstance(instance: Instance?, options: SaveInstanceOptions?): boolean
...
declare function lift_and_load_closure<A..., R...>(closure: (A...) -> R...): ((A...) -> R...)?
...
-- WebSocketClient (ExecutorWebSocketClient due to existing WebSocketClient class)
declare class ExecutorWebSocketClient
    IsClosed: boolean
...
declare WebSocket: {
    connect: ((url: string) -> ExecutorWebSocketClient),
}
...
declare DrawingImmediate: {
	...
	GetPaint: (z_index: number?) -> ExecutorSignal<>,
	Fonts: DrawingFonts
}
